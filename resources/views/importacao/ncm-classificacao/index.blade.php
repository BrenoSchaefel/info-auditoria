...
@section('title', 'Importar NCM × Classificação Tributária')
...
<div class="page-header">
    <div style="display:flex;align-items:center;gap:.6rem;margin-bottom:.2rem">
        ...
        <h1 class="page-title" style="margin:0">NCM × Classificação Tributária</h1>
    </div>
    <p class="page-subtitle" style="padding-left:1.8rem">
        Importe os NCMs vinculados às classificações tributárias a partir de um arquivo JSON.
    </p>
</div>
...
<div class="import-layout">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p style="font-size:.83rem;color:var(--text-muted);margin-bottom:1.5rem;line-height:1.55">
                    O arquivo deve ser um <strong>array de classificações tributárias</strong>, cada uma com a chave <code>Anexos</code> contendo os NCMs. Todos os registros existentes serão substituídos.
                </p>

                <form
                    method="POST"
                    action="{{ route('importacao.ncm-classificacao.importar') }}"
                ...
                >
                    ...
                    <div class="drop-zone" id="dropZone">
                        ...
                        <div id="dzIdle">
                            ...
                            <p class="drop-zone__hint">Somente <strong>.json</strong> · Máximo 20 MB</p>
                        </div>
    ...
    <div class="import-side">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="status-stat">
                    <span class="status-stat__label">NCMs na base</span>
        ...
        <div class="card">
            <div class="card-body">
                <h3 class="side-card-title">Campos importados</h3>
                <ul class="fields-list">
                    <li><code>CodNcmNbs</code> <span>Código NCM</span></li>
                    <li><code>TipoCodigo</code> <span>Tipo (NCM/NBS)</span></li>
                    <li><code>CodClassTrib</code> <span>Cod. classificação</span></li>
                    <li><code>NomeReduzido</code> <span>Nome reduzido</span></li>
                    <li><code>Cst</code> <span>CST</span></li>
                    <li><code>NroAnexo</code> <span>Nº do Anexo</span></li>
                    <li><code>DescCondicao</code> <span>Condição</span></li>
                    <li><code>DescItemAnexo</code> <span>Descrição do item</span></li>
                    <li><code>DescAnexo</code> <span>Descrição do anexo</span></li>
                    <li><code>TipoPermissao</code> <span>Tipo de permissão</span></li>
                    <li><code>DthIniVig</code> <span>Início de vigência</span></li>
                    <li><code>DthFimVig</code> <span>Fim de vigência</span></li>
                </ul>

                <p style="font-size:.73rem;color:var(--text-light);margin-top:.9rem;line-height:1.5">
                    Apenas itens com <code>TipoCodigo = "NCM"</code> são importados.
                </p>
            </div>
        </div>
...
<style>
    ...
    .drop-zone__link  { color: var(--primary); font-weight: 500; cursor: pointer; }
    ...
    .file-preview__remove {
        ...
        border-radius: 6px; cursor: pointer; padding: .35rem;
    ...
    .btn-import__label, .btn-import__loading {
    ...
    .fields-list span { color: var(--text-muted); }
